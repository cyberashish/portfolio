        ...
        <div className="container">
            <div className="grid grid-cols-12 gap-6 items-center">
               <div className="lg:col-span-6 col-span-12 lg:mt-0 mt-24">
                  ...
                  <p className='text-base font-medium text-body leading-relaxed mb-[65px] mt-8'>I'm a Frontend developer dedicated to crafting seamless digital experiences. With expertise in front-end , I transform complex concepts into intuitive, engaging user interfaces, blending functionality with aesthetics to captivate users at every interaction.</p>
